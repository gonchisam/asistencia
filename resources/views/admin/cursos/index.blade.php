                ...
                <div class="text-gray-900">
                    ...
                    <div class="flex items-start justify-between mb-8 pb-6 border-b border-gray-200">
                        ...
                        <div class="flex space-x-3">
                            ...
                            <a href="{{ route('admin.horarios.formulario') }}"
                               class="inline-flex items-center px-4 py-2 bg-yellow-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-wider hover:bg-yellow-700 active:bg-blue-800 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-md hover:shadow-lg">
                            ...
                            {{-- ¡NUEVO! Botón de Importar Completos: Estilo púrpura --}}
                            <a href="{{ route('admin.cursos.importar-completos.vista') }}"
                               class="inline-flex items-center px-4 py-2 bg-purple-600 border border-transparent rounded-lg font-semibold text-sm text-white uppercase tracking-wider hover:bg-purple-700 active:bg-purple-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 transition ease-in-out duration-150 shadow-md hover:shadow-lg">
                                <svg class="w-5 h-5 mr-2 -ml-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 014 4v2M9 19l3 3m0 0l3-3m-3 3V10"></path></svg>
                                Importar Completos
                            </a>
                            
                            {{-- Botón de Importar Inscripciones: Estilo verde moderno --}}
