    ...
    <div class="bg-white rounded-xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl w-full max-w-3xl mx-auto">
        ...
        <div class="flex items-center space-x-4 mb-8 pb-6 border-b border-gray-200">
            ...
            <h2 class="text-3xl font-extrabold text-gray-900">
                <span class="text-blue-600">Crear Nueva Aula</span>
            </h2>
        </div>
        ...
        <form action="{{ route('admin.aulas.store') }}" method="POST">
            ...
            {{-- Nota: El botón de guardar se espera que esté dentro de _form,
                 y debe usar <x-primary-button> o el estilo azul unificado. --}}
        </form>
